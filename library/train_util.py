...
class EnsuredDreamBoothDataset(DreamBoothDataset):
    def __init__(
        ...
        self.fix_reg_contrastive = False
    ...
    def initialize(
        ...
        for bucket in self.bucket_manager.buckets:
            fixed_collection = []
            non_fixed_collection = []
            for image_key in bucket:
                image_info = self.image_data[image_key]
                if target_caption in image_info.caption:
                    fixed_collection.append(image_key)
                else:
                    non_fixed_collection.append(image_key)
            fixed_bucket_indices.append(fixed_collection)
            non_fixed_bucket_indices.append(non_fixed_collection)
